...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <br><br>
  Degree:
  <input type="checkbox" id="exam1" name="exam1" value="SSC">
  <label for="exam1"> SSC</label>
  <input type="checkbox" id="exam2" name="exam2" value="HSC">
  <label for="exam2"> HSC</label>
  <input type="checkbox" id="exam3" name="exam3" value="BSc">
  <label for="exam3"> BSc</label>
  <input type="checkbox" id="exam4" name="exam4" value="MSc">
  <label for="exam4"> MSc</label>
  <span class="error">* <?php echo $dateofbirthErr;?></span>
  <br><br>
  Blood Group:
