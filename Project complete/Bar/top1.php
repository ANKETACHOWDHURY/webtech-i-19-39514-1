...
<header>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="navbar-nav">
      ...
      <a class="nav-link" href="showPrescription.php"><i class="fas fa-prescription-bottle-alt"></i>My Prescription</a> 
      <a class="nav-link" href="showPayment.php"><i class="fa fa-credit-card"></i>Patient Payment</a> 
